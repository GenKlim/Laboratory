...
public class BinarySearch {
    ...
    /**
     * Находит нижнюю границу в диапазоне, равную минимальному значению, для
     * которого компаратор вернул < 0
     *
    ...
    /**
     * Находит верхнюю границу в диапазоне, следующую за максимальным значением,
     * для которого компаратор вернул <= 0
     *
     * @param start начало диапазона (включительно)
     * @param end конец диапазона (не включительно)
     * @param comparator компаратор
