...
namespace VMath
{
    class Task3 : TaskBase
    {
        ...
        double df(double x, bool echo = true)
        {
            double val = 2 * x - (k + l);
        ...
        double ddf(double x, bool echo = true)
        {
            double val = 2;
        ...
        double horda(int n, double x, bool echo = true)
        {
            double fx = f(x, false);
            double fc = f(c, false);
        ...
        double secuh(int n, double x, double xm1, bool echo = true)
        {
            double fx = f(x, false);
        ...
        double nyton(int n, double x, bool echo = true)
        {
            double fx = f(x, false);
        ...
        double iter(int n, double x)
        {
            double vals = (k + l) * x - k * l;
            double val = Math.Sqrt(vals);
            logln("x{0} = v({1}) = sqrt({2}*{3} - {4}) = sqrt({5}) = {6}", n, n - 1, k + l, x, k * l, vals, val);
